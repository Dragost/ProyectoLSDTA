    ...
    <script>
                ...
                $(document).ready(function() {
                   ...
                   mitabla = $('#datatable').dataTable( {
                        ...
                        "bServerSide": false,
                        "bAutoWidth": true,
                        "sAjaxSource": "<?php echo base_url('admin/galerias/show');?>",
                        "language": {
                        ...
                        "aoColumns": [
                            ...
                            { "mData": "id",
                                "mRender": function(data, type, full){
                                    return '<a href="<?php echo base_url("admin/galerias/edit"); ?>/'+data+'" class="btn btn-success pull-right">Editar</a>';
                                },
                                "bSortable":false,
                                "bSearchtable":false
                            },
                            { "mData": "id",
                                "mRender": function(data, type, full){
                                    return '<a onclick="return sure()" href=<?php echo base_url("admin/galerias/del"); ?>/'+data+'" class="btn btn-danger pull-right">Eliminar</a>';
                                },
                                "bSortable":false,
                                "bSearchtable":false
                            }
    ...
    <script type="text/javascript">
        function sure() { //v4.0
            if (confirm("¡SE DISPONE A BORRAR EL EVENTO SELECCIONADO! \n Pulse Cancelar si no es esa su intención")){
                return true
            }else{
                return false
            }
