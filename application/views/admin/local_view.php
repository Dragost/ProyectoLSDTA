    ...
    <script>
                ...
                $(document).ready(function() {
                   ...
                   mitabla = $('#datatable').dataTable( {
                        ...
                        "bServerSide": false,
                        "bAutoWidth": true,
                        "sAjaxSource": "<?php echo base_url('admin/bares/show');?>",
                        "language": {
                        ...
                        "aoColumns": [
                            ...
                            { "mData": "id",
                                "mRender": function(data, type, full){
                                    return '<a href="<?php echo base_url("admin/bares/edit"); ?>/'+data+'" class="btn btn-success pull-right">Editar</a>';
                                },
                                "bSortable":false,
                                "bSearchtable":false
                            },
                            { "mData": "id",
                                "mRender": function(data, type, full){
                                    return '<a onclick="return sure()" href=<?php echo base_url("admin/bares/del"); ?>/'+data+'" class="btn btn-danger pull-right">Eliminar</a>';
                                },
                                "bSortable":false,
                                "bSearchtable":false
                            }
